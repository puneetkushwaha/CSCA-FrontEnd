    ...
    return (
        <div className="min-h-screen bg-black pt-20 relative overflow-hidden">
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <h1 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter mb-4">Accreditation & Standards</h1>
                <div className="h-1 w-20 bg-red-600 mb-8"></div>
                <p className="text-xl text-white/60 max-w-2xl font-light">
                    Adhering to global standards of excellence in cybersecurity training.
                </p>
            </div>
        </div>
    );
