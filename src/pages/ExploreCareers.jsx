    ...
    <div className="min-h-screen bg-black text-white pt-24 pb-12 font-['Inter']">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="max-w-3xl">
          <h1 className="text-5xl md:text-6xl font-black uppercase tracking-tight mb-6">
            Build a Cyber Career That Actually Pays{" "}
            <span className="text-red-600">— Not Just a Certificate</span>
          </h1>
          <p className="text-xl text-gray-400 leading-relaxed">
            CSCA maps real-world cybersecurity roles across Red Team, Blue Team,
            Cloud, GRC, AI Security, and Digital Forensics — aligned with real
            industry demand.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group relative bg-[#0a0a0a] border border-white/10 rounded-2xl overflow-hidden hover:border-red-600/50 transition-all duration-300">
            ...
            <div className="p-8">
              ...
              <p className="text-gray-400 mb-6 text-sm leading-relaxed min-h-[80px]">
                Red Team Operator | SOC Analyst | Cloud Security Engineer |
                Threat Intelligence Analyst | Cyber Law & Compliance Specialist |
          ...
          {/* Card 2 */}
          <div className="group relative bg-[#0a0a0a] border border-white/10 rounded-2xl overflow-hidden hover:border-blue-600/50 transition-all duration-300">
            ...
            <div className="p-8">
              ...
              <p className="text-gray-400 mb-6 text-sm leading-relaxed min-h-[80px]">
                Comprehensive insights into critical industries driving global
          ...
          <div className="group relative bg-[#0a0a0a] border border-white/10 rounded-2xl overflow-hidden hover:border-amber-600/50 transition-all duration-300">
            ...
            <div className="p-8">
              ...
              <p className="text-gray-400 mb-6 text-sm leading-relaxed min-h-[80px]">
                Dive deeper into your career possibilities with Careers+, a
