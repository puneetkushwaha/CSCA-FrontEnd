    ...
    return (
        <div className="relative min-h-screen bg-black text-white font-sans overflow-hidden">
            ...
            <header className="relative z-10 py-16 px-6 border-b border-white/10">
                <div className="max-w-[1440px] mx-auto">
                    ...
                    <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mb-10 leading-relaxed">
                        CSCA partners with state government agencies to deliver IT training and certification solutions.
                    </p>
            ...
            <main className="relative z-10 pt-20 pb-20 max-w-[1440px] mx-auto px-6 lg:px-8">
                        ...
                        <section className="grid md:grid-cols-2 gap-12 items-center mb-24">
                            <div>
                                ...
                                <p className="text-gray-400 text-lg mb-6 leading-relaxed">
                                    CSCA's solutions are tailored to meet state government agencies' unique needs. With flexible, instructor-led video learning and certification programs, we partner with you to navigate your procurement challenges.
                                </p>
                            </div>
                            ...
                            <div className="grid lg:grid-cols-3 gap-6">
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:-translate-y-2 transition-all duration-300">
                                    <div className="flex gap-2 mb-4">
                                        <span className="text-red-500 text-xs font-bold uppercase tracking-wider">State Govt</span>
                    ...
                    <>
                        <section className="text-center mb-24">
                            <h2 className="text-4xl md:text-5xl font-black mb-6">
                                Learn how CSCA is helping state <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-800">
                        ...
                        <section className="mb-24">
                            ...
                            <div className="grid lg:grid-cols-3 gap-6">
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:-translate-y-2 transition-all duration-300">
                                    ...
                                    <h4 className="text-2xl font-bold mb-4">
                                        Top Cybersecurity Tips for State Government
                                    </h4>
                                    <button className="text-gray-400 hover:text-white text-sm font-semibold flex items-center gap-2 mt-auto">
                                        Read Blog <ArrowRight className="w-4 h-4" />
                                    </button>
                    ...
                    <>
                        <section className="text-center mb-24">
                            ...
                            <p className="text-gray-400 text-lg max-w-4xl mx-auto leading-relaxed">
                                CSCA's upskilling pathways equip state government IT professionals with the knowledge and skills aligned to AI, Data, Cloud, Cyber, Digital Skills, Networking, and Tech Support. Combining these certifications with hands-on experience strengthens agency workforce readiness and compliance.
                            </p>
                        </section>
                ...
                {activeTab !== "Overview" && activeTab !== "Solutions" && activeTab !== "Resources" && activeTab !== "Upskilling Pathways" && activeTab !== "Case Studies" && (
