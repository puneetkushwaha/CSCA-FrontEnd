...
const OurCourses = () => {
    const [activeTab, setActiveTab] = useState('Red / Offensive');
        ...
        <section className="py-24 bg-black relative overflow-hidden">
            ...
            <div className="max-w-[1440px] mx-auto px-6 relative z-10 flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                    {currentCertifications.map((course, i) => (
                        <div
                            key={i}
                        ...
                        >
                            ...
                            <div className="p-8 flex flex-col h-full space-y-5">
                                <div className="flex justify-between items-center">
                                    ...
                                    {course.badge && (
                                        <span className="px-2 py-0.5 bg-red-600/10 border border-red-600/20 rounded-md text-[8px] font-bold text-red-500 uppercase tracking-widest">
                                            {course.badge}
                                        </span>
                                    )}
                                </div>
                                ...
                                <div className="mt-auto pt-6 border-t border-white/5">
                                    <div className="flex justify-between items-end">
                                        <Link to={`/certification/${course.id}`}>
                    ...
                    {currentCertifications.length === 0 && (
                        <div className="col-span-full py-20 flex flex-col items-center justify-center text-center border border-dashed border-white/10 rounded-2xl bg-white/5">
                            <div className="text-white/40 font-bold uppercase tracking-widest">Coming Soon</div>
                        </div>
                    )}
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-20 w-full animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    <Link to="/certifications" className="relative group overflow-hidden">
                        <div className="px-10 py-3.5 bg-white hover:bg-black rounded-full transition-all duration-200 flex items-center gap-3">
                            ...
                            <span className="relative z-10 text-[10px] font-black text-black group-hover:text-white uppercase tracking-[0.25em] transition-colors">View All Certifications</span>
                    ...
                    <Link to="/enterprise" className="relative group px-10 py-3.5 rounded-full border border-white hover:border-red-600/50 transition-all duration-300 overflow-hidden">
