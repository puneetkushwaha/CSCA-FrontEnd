    ...
    <footer className="bg-black text-white border-t border-red-600 relative overflow-hidden pt-28 pb-14 font-['Inter']">
      ...
      <div className="max-w-[1440px] mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-10 mb-24">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="inline-flex items-center gap-4 bg-[#0a0a0a] border border-white/10 p-4 rounded-2xl shadow-[0_0_30px_rgba(220,38,38,0.15)] group hover:border-red-600/50 transition-colors duration-500">
              ...
              <div>
                ...
                <p className="text-[9px] font-bold text-red-500 tracking-[0.25em] uppercase">
                  Red Team Ops
                </p>
              </div>
            </div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm pl-2 border-l-2 border-red-600/30">
              Forging the world's elite cyber defenders. We don’t just teach
              security — we simulate the war room.
            </p>
          ...
          {/* === Footer Links Grid === */}
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
            {/* Company */}
            <div className="space-y-6">
              <h4 className="text-xs font-black text-white uppercase tracking-[0.15em] pb-4 border-b border-white/10">
                Company
              </h4>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i}>
                    <Link
                      to="#"
                      className="text-xs font-bold text-gray-500 hover:text-red-500 hover:pl-2 transition-all uppercase tracking-wide flex items-center gap-2"
                    >
                      {item}
                    </Link>
                  </li>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i}>
                    <Link
                      to="#"
                      className="text-xs font-bold text-gray-500 hover:text-red-500 hover:pl-2 transition-all uppercase tracking-wide"
                    >
                      {item}
                    </Link>
                  </li>
            ...
            <div className="space-y-6">
              ...
              <h4 className="text-xs font-black text-white uppercase tracking-[0.15em] pt-6 pb-3 border-b border-white/10">
                Legal
              </h4>
              <ul className="space-y-3">
                {[
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6 relative">
          ...
          <div className="flex flex-col gap-1 text-center md:text-left">
            ...
            <p className="text-[10px] text-gray-600 font-mono">
              CSCA LTD © {new Date().getFullYear()} // SECURE CONNECTION
              ESTABLISHED
            </p>
          </div>
          ...
          <div className="flex gap-4">
            {[Twitter, Linkedin, Github, Youtube].map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="w-10 h-10 rounded-lg bg-[#0a0a0a] border border-white/5 flex items-center justify-center text-gray-500 hover:text-white hover:border-red-600 hover:bg-red-600 transition-all duration-300 group"
              >
